...
const { parkingAdd, updateParking, deleteParking, singleParking, allParkings, countByCity, countByType, getParkingSlot, searchByCity, getAllParkings, getParkingsBySearch } = require("../controllers/parkingController")
...
router.get("/allParkings/:src", getParkingsBySearch)
